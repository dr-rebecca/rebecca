...
if ( ! class_exists( 'Ovic_Price_Filter' ) && class_exists( 'OVIC_Widget' ) ) {
	class Ovic_Price_Filter extends OVIC_Widget
	{
		...
		public function __construct()
		{
			...
			$this->widget_description = esc_html__( 'Display the customer Price Filter.', 'armania' );
			$this->widget_id          = 'ovic_price_filter';
			$this->widget_name        = esc_html__( 'Ovic: Price Filter', 'armania' );
			$this->settings           = array(
				'title' => array(
					'type'  => 'text',
				...
				'price' => array(
					'type'    => 'group',
					'title'   => esc_html__( 'Price list', 'armania' ),
					'fields'  => array(
						array(
							'id'    => 'text',
							'type'  => 'text',
							'title' => esc_html__( 'Price text', 'armania' ),
						),
						array(
							'id'    => 'min',
							'type'  => 'text',
							'title' => esc_html__( 'Min value', 'armania' ),
							'after' => esc_html__( 'Price number or min | max. ( min: get min price, max: get max price )', 'armania' ),
						),
						array(
							'id'    => 'max',
							'type'  => 'text',
							'title' => esc_html__( 'Max value', 'armania' ),
							'after' => esc_html__( 'Price number or min | max. ( min: get min price, max: get max price )', 'armania' ),
						),
					),
					'default' => array(
						array(
							'text' => esc_html__( 'Max and Min Price', 'armania' ),
							'min'  => 'min',
							'max'  => 'max',
						)
					)

...
<div class="wcv-shop-settings">
    ...
    <h2><?php echo esc_html__( 'Settings', 'armania' ); ?></h2>
    ...
    <form method="post">
		...
		<?php if ( apply_filters( 'wcvendors_vendor_dashboard_bank_details_enable', true ) ) : ?>
            ...
            <h3><?php echo esc_html__( 'Bank Details', 'armania' ); ?></h3>
            <table>
                <tr>
                    <td><p class="form-row notes">
                            <label for="">
								<?php echo esc_html__( 'Account Name', 'armania' ); ?>
                            </label>
                    ...
                    <td><p class="form-row notes">
                            <label for="wcv_bank_account_number">
								<?php echo esc_html__( 'Account Number', 'armania' ); ?>
                            </label>
                    ...
                    <td><p class="form-row notes">
                            <label for="wcv_bank_name">
								<?php echo esc_html__( 'Bank Name', 'armania' ); ?>
                            </label>
                ...
                <tr>
                    <td><p class="form-row notes"><label
                                    for="wcv_bank_routing_number"><?php echo esc_html__( 'Routing Number', 'armania' ); ?></label><input
                    ...
                    <td><p class="form-row notes">
                            <label for="wcv_bank_iban">
								<?php echo esc_html__( 'IBAN', 'armania' ); ?>
                            </label>
                    ...
                    <td><p class="form-row notes">
                            <label for="wcv_bank_bic_swift">
								<?php echo esc_html__( 'BIC / Swift', 'armania' ); ?>
                            </label>
        ...
        <input type="submit" class="btn btn-inverse btn-small" style="float:none;" name="vendor_application_submit"
               value="<?php echo esc_html__( 'Save', 'armania' ); ?>"/>
    </form>

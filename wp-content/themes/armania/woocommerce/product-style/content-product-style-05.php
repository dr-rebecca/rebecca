...
$functions = array(
    ...
    array('add_action', 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_single_excerpt', 15),
    array('add_action', 'woocommerce_after_shop_loop_item_title', 'armania_flash_sale_percent', 15),
);
...
?>
    <div class="product-inner">
        ...
        <div class="product-info equal-elem">
            ...
            <?php armania_function_shop_loop_item_countdown(); ?>
        </div>
    </div>
<?php

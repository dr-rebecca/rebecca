(function ($) {
    ...
    window.addEventListener("load", function load() {
         ...
         * </div>
         *
         * @use: $('.sticky-content').armania_sticky_sidebar();
         * */
        $.fn.armania_sticky_sidebar = function () {
            var $this = $(this);
            if ( $this.closest('.wrapper-main-content').length ) {
                ...
                $this.on('armania_sticky_sidebar', function () {
                    $this.each(function () {
                        ...
                        $(window).on('scroll armania_load_more_post', function () {
                ...
                }).trigger('armania_sticky_sidebar');
        ...
        if ( $('.sticky-content').length ) {
            $('.sticky-content').armania_sticky_sidebar();
        }
    }, false);
